...
class ObservationGoogleActionsController < ActionController::Base
	...
	DEFAULT_DIALOG = {
		...
		launch_user: "Welcome to Life Meter.  To log fitness information just say \"Google tell Life Meter I ate 100 calories\", or use a fitness timer by saying \"Google ask Life Meter to start run timer\".  Life Meter will remember, report and provide insights into what you have told it.",
		launch_guest: "Welcome to Life Meter.  To log fitness information just say \"Google tell Life Meter I ate 100 calories\", or use a fitness timer by saying \"Google ask Life Meter to start run timer\".  Life Meter will remember, report and provide insights into what you have told it.  To get started open your Google app, and complete the Life Meter registration.",
