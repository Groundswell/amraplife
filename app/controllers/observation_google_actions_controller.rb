...
class ObservationGoogleActionsController < ActionController::Base
	...
	DEFAULT_DIALOG = {
		help: "To log fitness information like calories or a run, simply say \"Ok Google, tell Life Meter I ate 100 calories\" or \"Ok Google, tell Life Meter to log that I ran 100 meters\".  You can also use Life Meter to time and log your exercise.  For example you can start a timer for your run by saying \"Ok Google, tell Life Meter to start run timer\" and stop it by saying \"Ok Google, tell Life Meter to stop run timer\".  Life Meter will remember, report and provide insights into what you have told it.",
