...
class WorkoutMovementsController < ApplicationController
	...
	def create
		...
		@movement.seq ||= @movement.workout_segment.try(:max_movement_seq)
		@movement.save
	...
	private
		...
		def movement_params
			params.require( :workout_movement ).permit( :workout_id, :movement_id, :equipment_id, :workout_segment_id, :seq, :decription, :m_rx, :f_rx )
		end
end
