...
class ObservationGoogleActionsController < ActionController::Base
	...
	DEFAULT_DIALOG = {
		help: "To log fitness information tell Life Meter \"I ate 100 calories\" or \"log that I ran 100 meters\".  You can also use Life Meter to time and log your exercise.  For example you can start a timer for your run by asking Life Meter to \"start run timer\".  Life Meter will remember, report and provide insights into what you have told it.",
		launch_user: "Welcome to Life Meter.  To log fitness information tell Life Meter \"I ate 100 calories\" or \"log that I ran 100 meters\".  You can also use Life Meter to time and log your exercise.  For example you can start a timer for your run by asking Life Meter to \"start run timer\".  Life Meter will remember, report and provide insights into what you have told it.",
		launch_guest: "Welcome to Life Meter.  To log fitness information tell Life Meter \"I ate 100 calories\" or \"log that I ran 100 meters\".  You can also use Life Meter to time and log your exercise.  For example you can start a timer for your run by asking Life Meter to \"start run timer\".  Life Meter will remember, report and provide insights into what you have told it.  To get started open your Google app, and complete the Life Meter registration.",
